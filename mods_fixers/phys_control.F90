...
logical           :: state_debug_checks   = .false.    ! Extra checks for validity of physics_state objects
                                                       ! in physics_update.
!!== KZ_WATCON
logical, public   :: use_mass_borrower    = .true.     ! switch on tracer borrower, instead of using the QNEG3 clipping
logical, public   :: use_qqflx_fixer      = .true.     ! switch on water vapor fixer to compensate changes in qflx
!!== KZ_WATCON
