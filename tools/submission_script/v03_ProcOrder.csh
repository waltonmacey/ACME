...
### DIRECTORIES (8)
set code_root_dir    = ~/Code/
set run_root_dir     = default
#/p/lscratche/donahue5/
set short_term_archive_root_dir = /p/lscratche/donahue5/
...
set num_resubmits    = 11
set do_short_term_archiving      = false
set do_long_term_archiving       = false

### SIMULATION OPTIONS (10)
set atm_output_freq              = 0
set records_per_atm_output_file  = 10 

### PROCESS ORDERING OPTIONS (11)
set proc_order_bc  = 1,2,3,4,5
set detrain_conv   = .true.
...
#    http://www.cesm.ucar.edu/models/cesm1.0/cesm/cesm_doc_1_0_4/a3714.htm. Note that ACME always uses ne30 or ne240 in the atmosphere.
...
cat <<EOF >> user_nl_cam
 ...
 proc_order_bc = $proc_order_bc
 detrain_conv = $detrain_conv
EOF
