...
&ctl_nl
  ...
  ne                = 15                         ! number of elements per cube face (2dg)
  qsize             = 3                         ! num tracer fields
  ndays             = 10                        ! num simulation days: 0 = use nmax steps
  statefreq         = 5                         ! number of steps between screen dumps
...
&analysis_nl
  ...
  output_varnames1  ='ps','u','v','omega','T','Q'  !'T' ! variables to write to file
