...
module element_mod
  ...
  use elem_state_mod,         only: elem_state_t, derived_state_t, statecomponents, timelevels
  ...
  real (kind=real_kind), allocatable, target, public :: derived_vn0       (:,:,:,:,:)  ! (np,np,2,nlev,nelemd) vel for tracer advection
