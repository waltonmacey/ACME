...
os.system('mkdir '+cesmdir+'/components/clm/tools/shared/pointclm/plots/'+site+'_'+compset)
if (terminal == 'postscript'):
    os.system('ps2pdf '+plotfile+' '+plotfile[:-4]+'.pdf')
    os.system('mv '+plotfile[:-4]+'.pdf '+cesmdir+'/components/clm/tools/shared/pointclm/plots/'+ \
                  site+'_'+compset+'/')
    os.system('mv '+plotfile+' '+cesmdir+'/components/clm/tools/shared/pointclm/plots/'+ \
                  site+'_'+compset+'/') 
