  ...
  !*****************************************************************
    ...
    do while(associated(currentPatch))  
       ...
       do while(associated(currentCohort))
          if(veg_pp%woody(currentCohort%pft) == 0)then 
  ...
  !*****************************************************************
    ...
    do while(associated(currentPatch)) 
       ...
       if (currentPatch%fire == 1) then
          currentCohort => currentPatch%tallest;
          do while(associated(currentCohort))  
             if (veg_pp%woody(currentCohort%pft) == 1) then !trees only
          ...
          currentCohort => currentPatch%tallest;
          do while(associated(currentCohort))
             if (veg_pp%woody(currentCohort%pft) == 1.and.(tree_ag_biomass > 0.0_r8)) then !trees only
