...
subroutine hetfrz_classnuc_cam_calc( &
   ...
   real(r8) :: tmp_array(pcols,pver) !ndk
   ...
   !ndk call outfld('NIMIX_IMM', niimm_bc+niimm_dst, pcols, lchnk) !ndk original FP issue
   !ndk call outfld('NIMIX_CNT', nicnt_bc+nicnt_dst, pcols, lchnk)   
   !ndk call outfld('NIMIX_DEP', nidep_bc+nidep_dst, pcols, lchnk)
