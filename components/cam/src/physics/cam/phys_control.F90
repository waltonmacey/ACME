...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, cam_chempkg, waccmx_opt, deep_scheme, shallow_scheme, &
      ...
      proc_order_bc &                                         ! ProcOrdering - AaronDonahue - (09/09/2016): Added proc_order_bc to control process order
   !-----------------------------------------------------------------------------
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, microp_scheme_out, &
                       ...
                       ,proc_order_bc_out &                    ! ProcOrdering - AaronDonahue - (09/09/2016): Added proc_order_bc to control process order
                        )
...
! Include a call to retrieve the proc_order_bc component from namelist.
   ...
   if ( present(proc_order_bc_out       ) ) proc_order_bc_out     = proc_order_bc ! ProcOrdering - AaronDonahue - (09/09/2016): Get process order from namelist
