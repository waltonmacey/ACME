...
!   use gpm_gmi_mod, only:gpm_gmi_addsensor, gpm_gmi_adddefaultsensor, gpm_gmi_init, gpm_gmi_run, gpm_gmi_clean, gpm_gmi_toabt
   ...
   use GPM_CRTM_sensor_mod, only: GPM_CRTM_sensor_add, GPM_CRTM_sensor_init, GPM_CRTM_sensor_destroy, &
                                 GPM_CRTM_sensor_inquire
                              ! GPM_CRTM_sensor, GPM_CRTM_sensor_create
...
!   call gpm_gmi_clean()
   ...
   !testgmisensor = GPM_CRTM_sensor('abc','histabc',10,20,(/ (i, i=1,0) /),4)  
!   testgmisensor = GPM_CRTM_sensor_create('abc','histabc',10.0,20.0,(/2,3,4/))  
